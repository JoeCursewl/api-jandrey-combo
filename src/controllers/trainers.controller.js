...
export const getTrainersSaved = async (req, res) => {
  ...
  try {
    ...
    const { id } = req.params;
    const sQuery = `SELECT ts.id, ts.user_id, u.name, u.last_name, ts.trainer_id, t.name_trainer, t.packages_trainer, t.scheduel_trainer, t.info_trainer, t.status_trainer, ts.saved_at
